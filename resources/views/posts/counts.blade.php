...
<ul class="nav nav-tabs mt-3" id="myTab" role="tablist">
  ...
  <li class="nav-item">
    <a class="nav-link active" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false"><i class="fas fa-3x fa-oil-can"></i><p class="small text-center">Pee</p></a>
  </li>
  <li class="nav-item">
    <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false"><i class="fas fa-3x fa-poop"></i><p class="small text-center">Poop</p></a>
  </li>
</ul>
